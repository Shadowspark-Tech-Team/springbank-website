...
exports.checkAccountTransferLimit = checkAccountTransferLimit;
exports.recordTransferAmount = recordTransferAmount;
exports.remainingAttempts = remainingAttempts;
exports.windowTransferTotal = windowTransferTotal;
exports.checkVelocityAlert = checkVelocityAlert;
exports.checkVelocityAmountAlert = checkVelocityAmountAlert;
exports.resetAccountLimits = resetAccountLimits;
 ...
 */
const VELOCITY_AMOUNT_THRESHOLD = 10000;
 ...
 */
function checkAccountTransferLimit(accountId) {
    const now = Date.now();
 ...
 */
function recordTransferAmount(accountId, amount) {
    const now = Date.now();
...
function remainingAttempts(accountId) {
    const now = Date.now();
...
function windowTransferTotal(accountId) {
    const now = Date.now();
 ...
 */
function checkVelocityAmountAlert(accountId) {
    const total = windowTransferTotal(accountId);
    if (total < VELOCITY_AMOUNT_THRESHOLD)
        return false;
...
//# sourceMappingURL=accountLimiter.js.map